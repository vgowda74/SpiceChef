...
const MOCK_COOKBOOKS: Cookbook[] = [
  { id: 'cb1', title: 'Famous Indian Dishes', author: 'Culinary India', accent_color: '#6B4A2A', recipe_count: 10, created_at: '2026-03-01', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb1.jpg' },
  { id: 'cb2', title: 'Italian Classics', author: 'La Cucina Italiana', accent_color: '#7A3B28', recipe_count: 10, created_at: '2026-03-02', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb2.jpg' },
  { id: 'cb3', title: 'Mexican Fiesta', author: 'Casa Mexico', accent_color: '#5A6B2A', recipe_count: 10, created_at: '2026-03-03', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb3.jpg' },
  { id: 'cb4', title: 'Thai Kitchen', author: 'Bangkok Table', accent_color: '#2C4A3E', recipe_count: 10, created_at: '2026-03-04', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb4.jpg' },
  { id: 'cb5', title: 'Chinese Favorites', author: 'Wok & Fire', accent_color: '#6B2A2A', recipe_count: 10, created_at: '2026-03-05', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb5.jpg' },
  { id: 'cb6', title: 'Mediterranean Table', author: 'Olive & Herb', accent_color: '#2A4A6B', recipe_count: 10, created_at: '2026-03-06', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb6.jpg' },
  { id: 'cb7', title: 'Japanese Essentials', author: 'Umami Kitchen', accent_color: '#3D2A4A', recipe_count: 10, created_at: '2026-03-07', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb7.jpg' },
  { id: 'cb8', title: 'French Bistro', author: 'Maison Culinaire', accent_color: '#2A3D4A', recipe_count: 10, created_at: '2026-03-08', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb8.jpg' },
  { id: 'cb9', title: 'Middle Eastern Mezze', author: 'Souk & Spice', accent_color: '#4A3A2A', recipe_count: 10, created_at: '2026-03-09', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb9.jpg' },
  { id: 'cb10', title: 'American BBQ & Classics', author: 'Smoke & Grill', accent_color: '#3A2A1A', recipe_count: 4, created_at: '2026-03-10', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb10.jpg' },
  { id: 'cb11', title: 'Korean Home Cooking', author: 'Seoul Kitchen', accent_color: '#2A3A5A', recipe_count: 4, created_at: '2026-03-11', image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/cookbooks/cb11.jpg' },
];
...
const MOCK_RECIPES: Recipe[] = [
  // --- Vegetarian ---
  {
    ...
    duration_mins: 35, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r1.jpg',
  },
  {
    id: 'r2',
    cookbook_id: 'cb1',
    ...
    duration_mins: 90, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r2.jpg',
  },
  {
    id: 'r3',
    cookbook_id: 'cb1',
    ...
    duration_mins: 28, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r3.jpg',
  },
  {
    id: 'r4',
    cookbook_id: 'cb1',
    ...
    base_serves: 3,
    tags: ['Vegetarian', 'Indian', 'Paneer'],
    duration_mins: 40, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r4.jpg',
  },
  {
    id: 'r5',
    cookbook_id: 'cb1',
    ...
    duration_mins: 30, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r5.jpg',
  },
  // --- Non-Veg ---
  {
    id: 'r6',
    ...
    duration_mins: 55, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r6.jpg',
  },
  {
    id: 'r7',
    cookbook_id: 'cb1',
    ...
    duration_mins: 90, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r7.jpg',
  },
  {
    id: 'r8',
    cookbook_id: 'cb1',
    ...
    base_serves: 4,
    tags: ['Non-Veg', 'Indian', 'Chicken'],
    duration_mins: 45, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r8.jpg',
  },
  {
    id: 'r9',
    cookbook_id: 'cb1',
    ...
    duration_mins: 25, image_url: 'https://quejhlzniodtcxfoslpi.supabase.co/storage/v1/object/public/recipe-images/images/recipes/r9.jpg',
  },
  {
    id: 'r10',
    cookbook_id: 'cb1',
...
interface RecipeState {
  ...
  setRecipeImage: (recipeId: string, imageUrl: string) => void;
  setCookbookImage: (cookbookId: string, imageUrl: string) => void;
...
export const useRecipeStore = create<RecipeState>()(persist((set, get) => ({
  ...
  setCookbookImage: (cookbookId, imageUrl) =>
    set((state) => ({
      cookbooks: state.cookbooks.map((cb) =>
        cb.id === cookbookId ? { ...cb, image_url: imageUrl } : cb
      ),
    })),
  ...
  merge: (persisted: any, current) => {
    ...
    // Update persisted bundled recipes with latest data
    const updatedRecipes = (persisted.recipes || []).map((r: Recipe) =>
      bundledRecipeMap.has(r.id) ? { ...r, ...bundledRecipeMap.get(r.id) } : r
    );
    const persistedRecipeIds = new Set(updatedRecipes.map((r: Recipe) => r.id));
    const missingRecipes = MOCK_RECIPES.filter((r) => !persistedRecipeIds.has(r.id));

    return {
      ...current,
      cookbooks: [...updatedCookbooks, ...missingBundled],
      recipes: [...updatedRecipes, ...missingRecipes],
